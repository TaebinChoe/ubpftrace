...
const std::map<std::string, nargs_spec> CALL_NARGS = {
  ...
  { "local_rank",     { .min_args=0, .max_args=0 } },
  { "lustre_ost",     { .min_args=2, .max_args=2 } },
  { "macaddr",        { .min_args=1, .max_args=1 } },
  { "max",            { .min_args=3, .max_args=3 } },
  { "min",            { .min_args=3, .max_args=3 } },
  { "node",           { .min_args=0, .max_args=0 } },
  { "nodename",       { .min_args=0, .max_args=0 } },
  ...
  { "__builtin_local_rank", { .min_args=0, .max_args=0 } },
  { "__builtin_lustre_ost", { .min_args=2, .max_args=2 } },
  { "__builtin_node",       { .min_args=0, .max_args=0 } },
  { "__builtin_nodename",   { .min_args=0, .max_args=0 } },
  { "__builtin_rank",       { .min_args=0, .max_args=0 } },
