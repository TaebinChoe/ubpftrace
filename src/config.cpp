...
const std::map<std::string, AnyParser> CONFIG_KEY_MAP = {
  ...
  { "live_interval_ms", CONFIG_FIELD_PARSER(live_interval_ms) },
  { "live_dir", CONFIG_FIELD_PARSER(live_dir) },
  { "stream", CONFIG_FIELD_PARSER(stream) },
  { "stream_flush_ms", CONFIG_FIELD_PARSER(stream_flush_ms) },
  { "stream_buffer_kb", CONFIG_FIELD_PARSER(stream_buffer_kb) },
