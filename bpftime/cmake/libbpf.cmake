...
| sed 's/loongarch64/loongarch/'"
  ...
  add_custom_command(
    OUTPUT ${output_file}
    COMMAND clang -O2 -target bpf -c -g -D__TARGET_ARCH_${UNAME_ARCH_STRIPPED} -I${CMAKE_CURRENT_LIST_DIR}/../third_party/vmlinux/${UNAME_ARCH_STRIPPED} -I${LIBBPF_INCLUDE_DIRS}/uapi -I${LIBBPF_INCLUDE_DIRS} ${source_file} -o ${output_file}
    DEPENDS ${source_file}
  )
  add_custom_target(${target_name}
    DEPENDS ${output_file}
